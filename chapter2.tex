...
field contains the list of patterns that will be tried, in left-to-right order,
...
\begin{itemize}
  \item If the patterns and the sequence matched, some new bindings may have
    been generated which added to \texttt{e} will create the new environment
    \texttt{e'}. We then evalute the expression of the \texttt{guard} field. 
    \begin{itemize}
